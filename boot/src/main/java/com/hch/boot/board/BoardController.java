...
public class BoardController {
	...
	public String boardForm(Model model, @RequestParam(value="currentPage", required=false)String cp) {
	...
	public String boardContent(int no, Model model, RedirectAttributes ra) {
